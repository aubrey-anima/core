...
# 最近一次实跑:**1842 passed / 19 skipped**(2026-08-26,橱窗那一轮,rc=0,342 秒 ——
#   **不是独占跑的**:起跑 `uptime` load 7.95、收尾 8.52,机器上另有一个 204% CPU 的活
#   和一个 85% 的世界容器。**这一趟没有独占,所以那个秒数比上一趟更不该被当读数引用。**
